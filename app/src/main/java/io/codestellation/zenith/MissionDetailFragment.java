 ...
 * This fragment is either contained in a {@link MissionListActivity}
 * in two-pane mode (on tablets) or a {@link MissionDetailActivity}
 * on handsets.
 */
public class MissionDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.mission_detail)).setText(mItem.details);
        }
