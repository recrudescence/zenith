...
public class SQLQueries {
    ...
    public String getCategoryName(int i){
        return "SELECT * FROM categories JOIN all_missions ON categories.c_id = all_missions.m_c_id WHERE m_id = " + i  + ";" ;
    }
    ...
    public String getNumInProgress(){
        return "SELECT COUNT(*) FROM user_missions WHERE um_status = 'In Progress'";
    }
