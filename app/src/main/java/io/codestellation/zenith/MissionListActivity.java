...
/**
 * An activity representing a list of Missions. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link MissionDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link MissionListFragment} and the item details
 * (if present) is a {@link MissionDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link MissionListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class MissionListActivity extends ActionBarActivity
        implements MissionListFragment.Callbacks {
    ...
    /**
     * Callback method from {@link MissionListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.mission_detail_container, fragment)
                    .commit();
